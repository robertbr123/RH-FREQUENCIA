    ...
    if (existing.rows.length === 0) {
      ...
      result = await pool.query(
        `INSERT INTO system_settings (
          ...
          attendance_tolerance_minutes, entry_block_tolerance_minutes, max_daily_hours,
        ...
        [
          ...
          company_name, company_address, company_phone, company_email,
          timezone, date_format, time_format, language,
          attendance_tolerance_minutes, entry_block_tolerance_minutes ?? 60, max_daily_hours,
      ...
      result = await pool.query(
        `UPDATE system_settings SET
          ...
          entry_block_tolerance_minutes = $14,
          max_daily_hours = $15,
          enable_facial_recognition = $16,
          enable_qr_scanner = $17,
          require_geolocation = $18,
          require_photo = $19,
          enable_notifications = $20,
          enable_email_notifications = $21,
          auto_backup_enabled = $22,
          backup_frequency_days = $23,
          ad_enabled = $24,
          ad_title = $25,
          ad_subtitle = $26,
          ad_image_url = $27,
          ...
          ad_delay_seconds = $30,
          ec_show_photo = $31,
          ec_show_matricula = $32,
          ec_show_position = $33,
          ec_show_department = $34,
          ec_show_punctuality = $35,
          ec_show_graph = $36,
          ec_show_stats = $37,
          ec_show_vacation_holidays = $38,
          ec_show_records_list = $39,
          ec_records_limit = $40,
          ec_custom_title = $41,
          ec_custom_subtitle = $42,
