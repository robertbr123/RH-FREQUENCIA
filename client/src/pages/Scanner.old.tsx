...
export default function Scanner() {
  ...
  // Helper som para reproduzir som de votação com síntese de áudio (memoizado)
  ...
  // Otimizar relógio - atualizar apenas quando segundos mudam
  useEffect(() => {
    let frameId: number
  ...
  const startScanner = useCallback(async () => {
    try {
      ...
      await html5QrCode.start(
        cameraId,
        {
          fps: 5, // Reduzido de 10 para 5 FPS (melhor performance)
          qrbox: { width: 200, height: 200 }, // Reduzido área de scan
          aspectRatio: 1.0,
          verbose: false,
          // Configurações adicionais para performance
          disableFlip: true, // Desabilitar flip horizontal
        },
        onScanSuccess,
        onScanError
      )
  ...
  }, [stopScanner, startScanner, getPunchTypeLabel])
  ...
  // Função para verificar face e registrar ponto (memoizada)
  ...
  }, [playSuccessSound, getPunchTypeLabel])
  ...
  return (
    ...
    >
      ...
      {/* Relógio */}
      <div className="relative bg-gradient-to-br from-primary-500 via-primary-600 to-purple-600 rounded-2xl shadow-2xl p-8 mb-6 text-white overflow-hidden">
      ...
      {/* Scanner */}
      <div className="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 rounded-2xl shadow-2xl border-2 border-gray-200 dark:border-gray-700 p-8 mb-6">
            ...
            <>
              {!scanning && !result && (
                <div className="text-center space-y-4">
                  <div className="w-32 h-32 mx-auto bg-gradient-to-br from-primary-100 to-primary-200 dark:from-primary-900 dark:to-primary-800 rounded-3xl flex items-center justify-center mb-6">
                    <Scan className="w-16 h-16 text-primary-600 dark:text-primary-300" />
                  </div>
                  <button
                    onClick={startScanner}
                    className="flex items-center gap-3 px-10 py-5 bg-gradient-to-r from-primary-600 via-primary-700 to-purple-600 text-white rounded-2xl hover:from-primary-700 hover:via-primary-800 hover:to-purple-700 shadow-2xl hover:shadow-3xl transition-all duration-200 text-xl font-bold"
                  >
